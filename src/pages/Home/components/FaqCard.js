    ...
    <div className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
              <div>
                  <h2 id="accordion-flush-heading-1">
                      <button type="button" className="text-lg flex items-center justify-between w-full py-5 font-medium text-left text-gray-500 border-b border-gray-200 dark:border-gray-700 dark:text-gray-400" onClick = {()=>setShow(!show)}>
